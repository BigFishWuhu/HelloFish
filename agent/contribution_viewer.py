...
.user-copy { position: relative; box-sizing: border-box; width: 100%; border: 0; padding: 0 42px 0 0; color: inherit; background: none; font: inherit; text-align: left; cursor: pointer; }
...
.user-copy.copied-user small::after { position: absolute; right: 0; bottom: 0; border: 1px solid #b8c4c3; border-radius: 3px; padding: 1px 4px; color: #5f7274; background: #e9eeec; content: "已复制"; font-size: 9px; font-weight: 800; line-height: 12px; text-decoration: none; }
